...
model = build_simple_model((img_height, img_width, 3), len(train_generator.class_indices))

plot_model(model, to_file='model-mlearn1.png', show_shapes=True, show_layer_names=True)
...
model.save('output/model-mlearn1.h5')
